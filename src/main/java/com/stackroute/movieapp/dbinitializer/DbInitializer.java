package com.stackroute.movieapp.dbinitializer;
...
public class DbInitializer implements CommandLineRunner, ApplicationListener<ContextRefreshedEvent> {
    ...
    public void run(String... args) throws Exception {
        ...
        Movie movie1 = new Movie(2, "URI", "On a cruise to celebrate their parents' 30th wedding anniversary, a brother and sister deal with the impact of family considerations on their romantic lives.");
        Movie movie2 = new Movie(3, "PK", "This experimental satire is a comedy of ideas about an alien in the city, who asks questions that no one has asked before.");
